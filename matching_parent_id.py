...
def match_for_parent_in_azimuth(azimuth_all_cts_label_unique,asctb_parents):
    ...
    perfect_matches=perfect_matches.drop_duplicates(['Label_for_parent_match','Parent_Label_matched','AZ.CT/LABEL','AZ.CT/LABEL.Author'])
...
with pd.ExcelWriter("C:\CNS\Azimuth-asctb-label-comaprison-main2\Data\Parent_matched_asctb_2.xlsx") as writer:
...
with pd.ExcelWriter("C:\CNS\Azimuth-asctb-label-comaprison-main2\Data\Parent_matched_azimuth_2.xlsx") as writer:
...
with pd.ExcelWriter(r"C:\CNS\Azimuth-asctb-label-comaprison-main2\Data\Ubergrapjh_parents_not_found.xlsx") as writer:
